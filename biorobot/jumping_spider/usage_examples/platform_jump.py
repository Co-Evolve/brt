...
from biorobot.jumping_spider.environment.platform_jump.mjc_env import JumpingSpiderPlatformJumpEnvironmentConfiguration, \
...
def post_render(
        ...
        environment_configuration: JumpingSpiderPlatformJumpEnvironmentConfiguration,
) -> None:
...
def create_env(
    ...
    env_config = JumpingSpiderPlatformJumpEnvironmentConfiguration(
    ...
    env = JumpingSpiderPlatformJumpMJCEnvironment.from_morphology_and_arena(

...
class JumpingSpiderDirectedJumpMJCEnvironment(JumpingSpiderEnvironmentBase, MJCEnv):
    ...
    def _get_direction_to_target_platform(state: MJCEnvState) -> np.ndarray:
        target_platform_position = JumpingSpiderDirectedJumpMJCEnvironment._get_target_platform_position(state=state)
    ...
    def _get_distance_to_target_platform(state: MJCEnvState) -> np.ndarray:
        direction_to_target_platform = JumpingSpiderDirectedJumpMJCEnvironment._get_direction_to_target_platform(
            state=state)
